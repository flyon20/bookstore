  ...
  <a-spin :spinning="showSpin">
    <div class="main">
      ...
      <a-row :gutter="[20,20]">
        ...
        <a-col :sm="24" :md="24" :lg="12">
          <a-card title="热门图书比例" style="flex:1;">
...
const initCharts = () => {
  ...
  let option = {
    ...
    tooltip: {
      ...
      borderColor: 'transparent', // 使边框颜色透明
      borderWidth: 0, // 将边框宽度设为 0
    ...
    series: [
      {
        ...
        data: uvData,
        lineStyle: {
          color: '#1677ff', // 这里可以是任何合法的CSS颜色值
        },
        itemStyle: {
          normal: {
            color: '#003eb3', // 正常状态下的颜色
          },
          emphasis: {
            color: '#91caff', // 鼠标悬停（高亮）状态下的颜色
          }
        }
      },
      {
        ...
        data: pvData,
        lineStyle: {
          color: '#52c41a', // 这里可以是任何合法的CSS颜色值
        },
        itemStyle: {
          normal: {
            color: '#237804', // 正常状态下的颜色
          },
          emphasis: {
            color: '#b7eb8f', // 鼠标悬停（高亮）状态下的颜色
          }
        }
      }
    ]

<template>
  <div class="container">
    <div class="login-page pc-style">
      ...
      <div class="login-tab">
        <div class="tab-selected" @click="navigateToHome">
          <div class="hover-4">
            <a-tooltip placement="left" color="#69b1ff">
              <template #title>
                <span>点击返回首页</span>
              </template>
          <span>图书商城</span>
...
<!--            <input placeholder="请输入注册邮箱" v-model="pageData.loginForm.username" type="text" class="input">-->
            <a-input size="large" v-model:value="pageData.loginForm.username" type="text" placeholder="请输入注册邮箱账号" />
            <p class="err-view">
            </p>
          </div>
          <!---->
...
<!--            <input placeholder="请输入密码" v-model="pageData.loginForm.password" type="password" class="input">-->
            <a-input-password size="middle" v-model:value="pageData.loginForm.password" placeholder="请输入密码" />
            <p class="err-view">
            </p>
          </div>
...
.pc-style {
  ...
  border-radius: 2%;
  -webkit-box-shadow: 2px 2px 6px 6px #bfbfbf;
  box-shadow: 2px 2px 6px 6px #bfbfbf;
}

					...
					<div class="thing-infos-view">
						...
						<div class="thing-counts hidden-sm">
							<div class="count-item flex-view pointer" @click="addToWish()">
								...
								<div class="count-box flex-view">
									<div class="count-text-box">
										<span class="count-title">加入心愿单&数量</span>
									</div>
							...
							<div class="count-item flex-view pointer" @click="collect()">
								...
								<div class="count-box flex-view">
									<div class="count-text-box">
										<span class="count-title">收藏&数量</span>
									</div>
									<div class="count-num-box">
				...
				<div class="thing-content-view flex-view">
					<div class="main-content">
						<div class="order-view main-tab">
							<span class="tab" :class="selectTabIndex===index? 'tab-select':''"
								v-for="(item,index) in tabData" :key="index" @click="selectTab(index)">
								{{ item }}
							</span>
						...
						<div class="thing-comment" :class="selectTabIndex > 0? '':'hide'">
							...
							<div class="tab-view flex-view">
								...
								<div class="tab-box flex-view" v-if="commentData.length > 0">
									<span :class="sortIndex === 0? 'tab-select': ''"
										@click="sortCommentList('recent')">最新</span>
									<div class="line"></div>
...
<!--								<div class="comment-item" v-for="item in commentData">-->
                ...
                <div class="comment-item" v-for="item in pagedCommentData" :key="item.id">
...
<script setup>
  ...
  const pagedCommentData = ref([]);
  const handlePagination = () => {
    const startIndex = (currentPage.value - 1) * pageSize.value;
    const endIndex = startIndex + pageSize.value;
    pagedCommentData.value = commentData.value.slice(startIndex, endIndex);
  };

...
<!--            <input placeholder="请输入邮箱" v-model="tData.loginForm.username" type="text" class="input">-->
            <a-input size="middle" v-model:value="tData.loginForm.username" type="text" placeholder="请输入注册邮箱账号" />
            <p class="err-view">
            </p>
          </div>
        </div>
...
<!--            <input placeholder="请输入密码" v-model="tData.loginForm.password" type="password" class="input">-->
            <a-input-password size="middle" v-model:value="tData.loginForm.password" placeholder="请输入密码" />
            <p class="err-view">
            </p>
          </div>
        </div>
...
<!--            <input placeholder="请再次输入密码" v-model="tData.loginForm.repassword" type="password" class="input">-->
            <a-input-password size="middle" v-model:value="tData.loginForm.repassword" placeholder="请再次输入密码" />
            <p class="err-view">
            </p>
          </div>
        </div>
